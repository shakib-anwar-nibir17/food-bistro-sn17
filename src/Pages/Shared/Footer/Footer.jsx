const Footer = () => {
  return (
    <footer>
      <div className="flex text-white h-[400px]">
        <div className="bg-[#1F2937] text-center w-1/2 h-full flex flex-col justify-center">
        ...
        <div className="bg-[#111827] text-center w-1/2 flex flex-col justify-center  h-full">
          <h2 className="text-3xl mb-3">Follow Us</h2>
      ...
      <div className="bg-[#151515] text-white text-center">
        <p className="py-6">Copyright © CulinaryCloud. All rights reserved.</p>
      </div>
    </footer>
  );
};
